...
children: [{path: 'vehicle', component: vehiclechecklistComponent},{path: 'extension', component: visaextensionComponent},{path: 'guesthouse', component: guesthousechecklistComponent},{path: 'transport', component: transportrequestComponent},{path: 'services', component: ghservicesComponent}]},{path: 'login', component: loginComponent},{path: 'unauthorized', redirectTo: '/login', pathMatch: 'full'},{path: 'admin', component: adminComponent},{path: '', redirectTo: '/home', pathMatch: 'full'},{path: '**', component: PageNotFoundComponent}]
